...
CREATE TABLE IF NOT EXISTS satellites (
  ...
  name VARCHAR(100) NOT NULL,
  description TEXT,
  status ENUM('Operational', 'Maintenance', 'Warning', 'Critical', 'Inactive') DEFAULT 'Operational',
  type VARCHAR(100),
  launch_date DATE,
  altitude FLOAT,
  orbit VARCHAR(50),
...
('Admin User', 'admin@astrogrid.com', 'password123', 'Admin'),
('Controller User', 'controller@astrogrid.com', 'password123', 'Controller'),
('Observer User', 'observer@astrogrid.com', 'password123', 'Observer');
