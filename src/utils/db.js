...
const mockQuery = (sql, params) => {
    ...
    if (sql.includes('SELECT * FROM users')) {
        ...
        return [
            { id: 1, name: 'AstroSat-1', status: 'Operational', altitude: 650, operator: 'ISRO', type: 'Earth Observation', orbit: 'LEO', launch_date: '2023-01-15' },
            { id: 2, name: 'Resourcesat-2A', status: 'Operational', altitude: 817, operator: 'ISRO', type: 'Earth Observation', orbit: 'LEO', launch_date: '2022-03-22' },
            { id: 3, name: 'GSAT-19', status: 'Operational', altitude: 35786, operator: 'ISRO', type: 'Communication', orbit: 'GEO', launch_date: '2021-11-05' }
        ];
    } else if (sql.includes('SELECT * FROM ground_stations')) {
        return [
            { id: 1, name: 'Bangalore Station', location: 'Bangalore, India', status: 'Operational', coordinates: { latitude: 12.9716, longitude: 77.5946 } },
            { id: 2, name: 'Chennai Station', location: 'Chennai, India', status: 'Operational', coordinates: { latitude: 13.0827, longitude: 80.2707 } },
            { id: 3, name: 'Lucknow Station', location: 'Lucknow, India', status: 'Maintenance', coordinates: { latitude: 26.8467, longitude: 80.9462 } }
        ];
