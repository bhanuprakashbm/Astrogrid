        ...
        return (
            <div className="container mx-auto px-4 py-8">
                <div className="text-center py-12">
                    <h1 className="text-3xl font-bold text-white mb-6">Operator Management</h1>
                    <div className="bg-red-500 bg-opacity-20 border border-red-500 text-white p-4 rounded-lg mb-6 inline-block">
                        <p className="text-lg">Access Denied</p>
                        <p className="text-sm text-gray-300 mt-1">Only administrators can access this page.</p>
                    </div>
                </div>
            </div>
        );
                                ...
                                <div className="flex space-x-2">
                                    {!editMode && (
                                        <button
                                            ...
                                            className="bg-space-blue hover:bg-blue-700 text-white px-3 py-1 rounded-md transition duration-300 text-sm"
                                        >
                                            Edit
                                        </button>
                                    )}
                                    <button
                                        ...
                                        className="bg-red-600 hover:bg-red-700 text-white px-3 py-1 rounded-md transition duration-300 text-sm"
                                    >
                                        Delete
                                    </button>
                                </div>
